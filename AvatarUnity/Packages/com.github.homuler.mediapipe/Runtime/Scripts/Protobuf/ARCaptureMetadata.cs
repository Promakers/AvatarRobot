...
namespace Mediapipe {
  ...
  public sealed partial class AVDepthData : pb::IMessage<AVDepthData> {
    ...
    public AVDepthData(AVDepthData other) : this() {
      ...
      cameraCalibrationData_ = other.HasCameraCalibrationData ? other.cameraCalibrationData_.Clone() : null;
    ...
    /// <summary>Gets whether the camera_calibration_data field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool HasCameraCalibrationData {
      get { return cameraCalibrationData_ != null; }
    }
    /// <summary>Clears the value of the camera_calibration_data field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void ClearCameraCalibrationData() {
      cameraCalibrationData_ = null;
    }
    ...
    public override int GetHashCode() {
      ...
      if (HasCameraCalibrationData) hash ^= CameraCalibrationData.GetHashCode();
    ...
    public void MergeFrom(AVDepthData other) {
      ...
      if (other.HasCameraCalibrationData) {
        if (!HasCameraCalibrationData) {
  ...
  public sealed partial class ARLightEstimate : pb::IMessage<ARLightEstimate> {
    ...
    public ARLightEstimate(ARLightEstimate other) : this() {
      ...
      primaryLightDirection_ = other.HasPrimaryLightDirection ? other.primaryLightDirection_.Clone() : null;
    ...
    /// <summary>Gets whether the primary_light_direction field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool HasPrimaryLightDirection {
      get { return primaryLightDirection_ != null; }
    }
    /// <summary>Clears the value of the primary_light_direction field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void ClearPrimaryLightDirection() {
      primaryLightDirection_ = null;
    }
    ...
    public override int GetHashCode() {
      ...
      if (HasPrimaryLightDirection) hash ^= PrimaryLightDirection.GetHashCode();
    ...
    public void MergeFrom(ARLightEstimate other) {
      ...
      if (other.HasPrimaryLightDirection) {
        if (!HasPrimaryLightDirection) {
  ...
  public sealed partial class ARCamera : pb::IMessage<ARCamera> {
    ...
    public ARCamera(ARCamera other) : this() {
      ...
      eulerAngles_ = other.HasEulerAngles ? other.eulerAngles_.Clone() : null;
    ...
    /// <summary>Gets whether the euler_angles field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool HasEulerAngles {
      get { return eulerAngles_ != null; }
    }
    /// <summary>Clears the value of the euler_angles field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void ClearEulerAngles() {
      eulerAngles_ = null;
    }
    ...
    public override int GetHashCode() {
      ...
      if (HasEulerAngles) hash ^= EulerAngles.GetHashCode();
  ...
  public sealed partial class ARFaceAnchor : pb::IMessage<ARFaceAnchor> {
    ...
    public ARFaceAnchor(ARFaceAnchor other) : this() {
      _hasBits0 = other._hasBits0;
      geometry_ = other.HasGeometry ? other.geometry_.Clone() : null;
      blendShapes_ = other.HasBlendShapes ? other.blendShapes_.Clone() : null;
      transform_ = other.transform_.Clone();
    ...
    /// <summary>Gets whether the geometry field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool HasGeometry {
      get { return geometry_ != null; }
    }
    /// <summary>Clears the value of the geometry field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    /// <summary>Gets whether the blend_shapes field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool HasBlendShapes {
      get { return blendShapes_ != null; }
    }
    /// <summary>Clears the value of the blend_shapes field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (HasGeometry) hash ^= Geometry.GetHashCode();
      if (HasBlendShapes) hash ^= BlendShapes.GetHashCode();
      hash ^= transform_.GetHashCode();
  ...
  public sealed partial class ARPlaneAnchor : pb::IMessage<ARPlaneAnchor> {
    ...
    public ARPlaneAnchor(ARPlaneAnchor other) : this() {
      ...
      extent_ = other.HasExtent ? other.extent_.Clone() : null;
  ...
  public sealed partial class ARFrame : pb::IMessage<ARFrame> {
    ...
    public ARFrame(ARFrame other) : this() {
      ...
      depthData_ = other.HasDepthData ? other.depthData_.Clone() : null;
      depthDataTimestamp_ = other.depthDataTimestamp_;
      camera_ = other.HasCamera ? other.camera_.Clone() : null;
      lightEstimate_ = other.HasLightEstimate ? other.lightEstimate_.Clone() : null;
      faceAnchor_ = other.HasFaceAnchor ? other.faceAnchor_.Clone() : null;
      planeAnchor_ = other.planeAnchor_.Clone();
      rawFeaturePoints_ = other.HasRawFeaturePoints ? other.rawFeaturePoints_.Clone() : null;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    /// <summary>Gets whether the depth_data field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool HasDepthData {
      get { return depthData_ != null; }
    }
    /// <summary>Clears the value of the depth_data field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    /// <summary>Gets whether the light_estimate field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool HasLightEstimate {
      get { return lightEstimate_ != null; }
    }
    /// <summary>Clears the value of the light_estimate field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void ClearLightEstimate() {
      lightEstimate_ = null;
    }
    ...
    /// <summary>Gets whether the face_anchor field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool HasFaceAnchor {
      get { return faceAnchor_ != null; }
    }
    /// <summary>Clears the value of the face_anchor field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void ClearFaceAnchor() {
      faceAnchor_ = null;
    }
    ...
    /// <summary>Gets whether the raw_feature_points field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool HasRawFeaturePoints {
      get { return rawFeaturePoints_ != null; }
    }
    /// <summary>Clears the value of the raw_feature_points field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void ClearRawFeaturePoints() {
      rawFeaturePoints_ = null;
    }
    ...
    public override int GetHashCode() {
      ...
      if (HasDepthData) hash ^= DepthData.GetHashCode();
      ...
      if (HasLightEstimate) hash ^= LightEstimate.GetHashCode();
      if (HasFaceAnchor) hash ^= FaceAnchor.GetHashCode();
      hash ^= planeAnchor_.GetHashCode();
      if (HasRawFeaturePoints) hash ^= RawFeaturePoints.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
